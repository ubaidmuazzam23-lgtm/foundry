...
//           <h2 className="text-3xl font-bold text-gray-900">Welcome back to Foundry</h2>
//           <p className="mt-2 text-gray-600">Sign in to validate your startup ideas</p>
//         </div>
//         <SignIn 
//           appearance={{
//             elements: {
  ...
  return (
    <div style={{
      ...
      <p style={{ position: 'relative', zIndex: 1, marginTop: 20, fontSize: 12, color: '#6B7455', textAlign: 'center' }}>
        ...
        <a href="/sign-up" style={{ color: '#636B2F', fontWeight: 600, textDecoration: 'none' }}>
          Start for free →
        </a>
      </p>
    </div>
